...
-   **"Service Provider"** means the Person or Persons appointed by the DAO to perform administrative services, responsibilities, and duties to carry on the DAO's operations. The initial Service Provider shall be dao-lawfirm.eth, its predecessor entities, or any future entity of dao-lawfirm.eth.
...
Contributors to the DAO with regards to development of it application for compensation will execute the innovations and assignments agreement of DAOLABs, LLC by which the DAO licenses its application.
